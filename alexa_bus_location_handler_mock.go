...
func (m *MockBusLocationHandler) GetBusTimes(ctx context.Context, r AlexaRequest) (AlexaTextResponse, error) {
	ret := m.ctrl.Call(m, "GetBusTimes", ctx, r)
...
func (mr *MockBusLocationHandlerMockRecorder) GetBusTimes(ctx, r interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBusTimes", reflect.TypeOf((*MockBusLocationHandler)(nil).GetBusTimes), ctx, r)
}
